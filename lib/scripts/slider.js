export default class Slider {
  ...
  updateSectionWhenKeydown(slider, openSlide, scroller, navSlider) {
    window.addEventListener("keydown", (e) => {
      if (
        [...slider.children][openSlide].getBoundingClientRect().top ===
        window.pageYOffset - window.innerHeight * scroller.getOpenSection
      ) {
  ...
  createSlider(sliders, scroller) {
    sliders.forEach((slider) => {
      ...
      this.updateSectionWhenKeydown(slider, openSlide, scroller, navSlider)
